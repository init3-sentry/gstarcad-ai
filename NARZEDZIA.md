...
> **Wydane 2026-09-09** (release `2026.09.09-31529ce`, .pyd) po walidacji runtime end-to-end (Wiktor 2026-09-08, GstarCAD 260827). Status w katalogu = 🟡 do formalnego odbioru Roberta („kontekst działki") — na stronę dopiero po jego werdykcie.
>
> **Status: kodowo gotowe, self-test offline 13/13, BEZ runtime-pass.** Dostawa do testów zespołu w poniedziałek, potem odbiór praktyka (Robert). Opis (2 wersje) + kafelek Niny = **szkic do odbioru Roberta** — na stronę dopiero po jego werdykcie. W budowie (poniżej).
