...
> ### 🆕 Aktualizacja 2026-09-04 — GSAI_WMS (podkład z geoportalu, darmowy magnes)
>
...
| **`GSAI_DL`** / **`GSAI_DL`** | Suma długości; `_OPIS` dokłada etykietę na rysunku. | [GSAI_DL.py](biblioteka-rag/przyklady/GSAI_DL.py) · [29_dlugosc_opis.py](biblioteka-rag/przyklady/29_dlugosc_opis.py) | Zwalidowane na **ŚWIEŻYM** rysunku (Jakub 29.07), ale 🔴 **BUG-10 na zapisanych** (`length` pada). Do przepisania na `entget` albo fix R&D. |
