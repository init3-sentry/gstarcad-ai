...
- `GSAI_WARSTWY_STANDARD` — Tworzy polski standard warstw (branże A/K/instalacje/Z + systemowe, ~165 warstw) jednym poleceniem, panel wyboru branż. Natywnie brak. Generatywne → BUG-10-safe.
